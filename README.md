### Ironsworn: Legacies Playtest Alpha 1 hackish Datasworn ruleset
...
- Moves
  - Take Action
  - Undertake a Quest, Resolve the Quest
  - Take on a Challenge, Resolve an Objective, Resolve a Challenge
  - Pass Time
...
There are no oracles, codex, or advantage/misfortune handling. I recommed to use the "Roll Dice" command and OOC comments for oracle rolls, and OOC comments for everything else.
